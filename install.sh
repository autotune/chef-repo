...
echo "alias chefrun='chef-solo -c /root/chef-repo/solo.rb -j /root/chef-repo/web.json -l debug'" >> ~/.bashrc
source ~/.bashrc 
chef-solo -c /root/chef-repo/solo.rb -j /root/chef-repo/web.json -l debug
